...
import { ResourceTemplateTableComponent } from './resource-template/resource-template-table/resource-template-table.component';
import { SystemAnalyticsComponent } from './system-analytics/system-analytics.component';
import { SystemAnalyticsChartComponent } from './system-analytics/system-analytics-chart/system-analytics-chart.component';
...
@NgModule({
  declarations: [
    ...
    ResourceTemplateTableComponent,
    SystemAnalyticsComponent,
    SystemAnalyticsChartComponent
  ],
  imports: [
    CommonModule,
    AdminRoutingModule,
