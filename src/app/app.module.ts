...
import { ResourceTemplateState } from './states/resource-template.state';
import { StatisticsState } from './states/statistics.state';
import { provideAnimationsAsync } from '@angular/platform-browser/animations/async';
import { ViewDescriptionDialogComponent } from './components/search-result/view-description-dialog/view-description-dialog.component';
