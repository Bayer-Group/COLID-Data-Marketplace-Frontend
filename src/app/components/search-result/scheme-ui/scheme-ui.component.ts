...
import { SchemaUIResult, SchemeUi, SchemeUiResult } from 'src/app/shared/models/schemeUI';
import { DocumentMap, Metadata, SearchHit } from 'src/app/shared/models/search-result';
