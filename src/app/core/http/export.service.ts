...
export class ExportService {
  ...
  getExportResultsPayload(exportSettings: ExportSettings, route: ActivatedRoute): ExcelExportPayload {
  ...
  getExportSelectedResultsPayload(exportSettings: ExportSettings, pidUris: string[]): ExcelExportPayload {
    const payload: ExcelExportPayload = {
      exportSettings,
      searchRequest: null,
      pidUris
